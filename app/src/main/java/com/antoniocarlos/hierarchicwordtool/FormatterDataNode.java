...
public class FormatterDataNode extends DataNode<String,String>{
  /** 
   * StringBuilder used to construct the output efficiently.
   * 
   */
  protected StringBuilder out;
  /** 
   * Constant that represents the spaces that should be accounted when formatting the table.
   * 
   */
  public static final int PADDING = 5;
  /** 
   * Label for the capturing time of the parameters.
   * 
   */
  public static final String L1  = "Tempo de captura dos parametros";
  /** 
   * Label for the counting time.
   * 
   */
  public static final String L2  = "Tempo de comparaçao";
  
  /** 
   * Produces and returns the data (the formatted message), requesting the required pieces of information for said computation.
   * 
   * @return String the data generated by this DataNode instance, i.e. the formatted mesage.
   */
  @Override
